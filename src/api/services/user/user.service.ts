...
import {
  DeleteEntryCodeSchema,
  type DeleteEntryCodeRequest,
} from '@/api/services/user/schemas/delete-code.schema'
import {
  LoginRequestSchema,
  type LoginRequest,
} from '@/api/services/user/schemas/login.schema'
...
export const setEntryCode = async (
  ...
  return apiClient.post('/api/v1/user/entry_code', payload, {
...
export const changeEntryCode = async (
  ...
  return apiClient.patch('/api/v1/user/entry_code', payload, {
...
export const getUserOperations = async (
  ...
  return apiClient.get('/api/v1/user/operations', params, {
