    ...
    <S.Container>
      <S.Header>
        ...
        {transaction.type === 'withdraw' && transaction.amountUSD && (
          <S.TransactionAmountUSD>{transaction.amountUSD}</S.TransactionAmountUSD>
        )}
      ...
      <S.DetailsSection>
        {transaction.type === 'withdraw' && transaction.exchangeRate && (
          <S.Block>
            <S.DetailRow>
              <S.DetailLabel>{t('currency.transactions.exchangeRate')}</S.DetailLabel>
        ...
        <S.Block>
          {transaction.creditAmount && (
            <S.DetailRow>
              <S.DetailLabel>{t('currency.transactions.creditAmount')}</S.DetailLabel>
              <S.DetailValue>{formatAmount(transaction.creditAmount)}</S.DetailValue>
            </S.DetailRow>
          )}
          {transaction.receivedAmount && (
            <S.DetailRow>
              <S.DetailLabel>{t('currency.transactions.receivedAmount')}</S.DetailLabel>
