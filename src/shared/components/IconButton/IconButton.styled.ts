...
export const IconButtonContainer = styled.button<IconButtonStyledProps>((props) => {
  ...
  return {
    ...
    '&:hover': props.$disabled
      ? {}
      : {
        backgroundColor: props.$hoverBackgroundColor || props.theme.colors.neutral200,
...
export const IconWrapper = styled.div<IconButtonStyledProps>(({$size, $iconColor, $disabled, $hoverIconColor, theme}) => {
